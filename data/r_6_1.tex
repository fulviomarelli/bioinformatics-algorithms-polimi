...
\mysidefigure{\myimage{6_1/1.jpg}\\}{An evolutionary tree diagram of Madagascan reptiles, radiating outward to show species divergence based on similarities in the cytochrome oxidase subunit I (COI) gene.}[0.4]
...
\myimage{6_1/3.jpg}{A dense phylogenetic tree mapping the evolutionary divergence of SARS-CoV-2 variants as of March 2022, grouping different branches by variant types (e.g., Omicron, Delta).}[width=0.6\textwidth]
...
\myimage{6_1/6.png}{A schematic of a 3D unit cube representing the 7 possible paths to reach the furthest node on the hyperlattice, illustrating the transitions for matching characters vs introducing gaps.}[width=0.7\textwidth]
...
\myimage{6_1/7.jpg}{}[width=0.7\textwidth]
...
\myimage{6_1/8.png}{}[width=0.6\textwidth]
