...
\begin{itemize}
    ...
    \item \textbf{Average distance (UPGMA):} The weighted average distance across all pairs between cluster A and cluster B. \sta This is the standard and most effective choice for sequence profiles.
\end{itemize}
