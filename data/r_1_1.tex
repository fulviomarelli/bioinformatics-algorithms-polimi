...
\myimage{1_1/1.jpg}{Structure of a protein complex (Polycomb complexes PRC1 and PRC2) interacting with a functional element in the genome.}[width=0.6\textwidth]
...
\mysidefigure{\myimage{1_1/9.png}\\
}{\begin{center}
             The standard genetic code table mapping mRNA codons (first, second, and third letters) to their respective amino acids.
\end{center}
}
...
\myimage{1_1/4.jpg}{Chromatogram output of a Sanger sequencing run, showing a series of colored peaks (red, green, blue, black/yellow) over time, representing the sequence of bases.}[width=0.6\textwidth]
