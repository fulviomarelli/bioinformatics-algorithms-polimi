...
\myimage{7_1/6.jpg}{}[width=0.6\textwidth]
...
\mysidefigure{\myimage{7_1/8.png}\\}{\myimage{7_1/9.png}\\}[0.46]
...
\myimage{7_1/11.jpg}{}[width=0.6\textwidth]
...
\myimage{7_1/12.png}{}[width=0.6\textwidth]
...
\mysidefigure{Before an HMM can decode a genome, we must estimate its parameters: transition probabilities (\( a_{kl} \)) and emission probabilities (\( e_k(x) \)).}{\myimage{7_1/13.png}\\}[0.4]
...
\myimage{7_1/14.png}{}[width=0.6\textwidth]
