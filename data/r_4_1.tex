...
\myimage{4_1/8.jpg}{Suffix trie of the string T="MISSISSIPPI\$". The tree branches out from the root showing every possible suffix path. Deeply branching nodes represent repeated substrings, like "SSI" and "I".}
...
\myimage{4_1/9.jpg}{Transformation from a Suffix Trie to a Suffix Tree for the string "MISSISSIPPI\$". Long single-path chains like "ISSIPPI\$" are merged into a}
